...
| Use case | Requirements | Frequency |
| --- | --- | --- |
| **Boarding client daily update** | Sharp, natural expression, sent the same day | 1–3 photos + 1 short video per dog per day |
| **Puppy growth record / adoption listing** | Same angle over time, clean background, body shape and coat clearly visible | Once a week at a fixed time + milestones (eyes opening, weaning, vaccinations) |
| **Social media** | Storytelling, high quality, vertical first | 2–3 best clips per site per week |

Different uses demand different gear and technique: a phone is plenty for daily updates; adoption listings and social content are worth shooting properly on better equipment.

## 2. Choosing Equipment: By Budget Tier

> Prices are rough guides (AUD, 2026) — check current retail. Principle: **master the phone first, buy gear second.**
...
A pocket gimbal camera like the **DJI Osmo Pocket 3** is a dog-filming powerhouse:

- Built-in mechanical stabilisation — footage stays smooth even chasing a running puppy
- Tiny body that can shoot from ground level for a true "dog's-eye view"
- Subject tracking keeps the lens on the dog automatically
- 1-inch sensor handles dim indoor light far better than a phone

**Recommend the company buys one unit shared across all four sites**, mainly for adoption videos and social content.

### Tier 2: Action camera (approx. A$600–750)

A GoPro (Hero 13 Black) or DJI Osmo Action. Their strengths: **drop-proof, waterproof, and the whole body can be wiped down with disinfectant** — great for placing inside pens for ultra-low angles, bath time, and outdoor zoomies. Weaknesses: mediocre in low light and worse than a phone for stills. A useful supplement, not a first choice.

### Tier 3: APS-C mirrorless (approx. A$1,100–1,900 with lens)

To take adoption and marketing shots to a professional level, choose a mirrorless body with **animal eye autofocus**:

- **Sony ZV-E10 II / a6700**: extremely fast animal eye AF, strong video
- **Canon EOS R50**: beginner-friendly, flattering colours

Pair it with an **f/1.8 prime lens** (35mm or 50mm equivalent) and low-light performance and background blur jump a whole tier. This tier is optional — wait until social media operations have a clear need.

### Tier 4: Fixed / monitoring cameras (approx. A$50–120 each)

Indoor cameras such as Tapo or eufy installed in the K4 puppy area serve double duty:

- Duty staff and the night shift can check on puppies remotely (supplementing night rounds, never replacing them)
- Time-lapse clips can be exported (clients adore footage of puppies sleeping and nursing)

Choose models with **night vision, 2K+ resolution, and clip export**. Note: monitoring footage touches on site security — get the manager's approval before publishing any exported clip.

### Essential small accessories (approx. A$100–150 total)

- Phone tripod + Bluetooth remote (approx. A$40)
...
- **No posing, no forcing positions**: pat the ground or lure with a toy; pick-up-and-pose shots only by staff experienced with that puppy, never higher than knee height off the ground
...
- **Same order as cleaning work: puppy area (K4) first, adult areas after** — never backtrack
- Before entering the puppy area: wash hands, wipe the entire phone/camera with **70% alcohol wipes** (screen, edges, lanyard included); action cameras can be wiped all over
- Wipe equipment again after leaving the puppy area before taking it anywhere else
- Keep tripods, fill lights and other large items **dedicated to one area** — don't carry them across areas
- **Flash and strong fill light must never be aimed at puppies' eyes**; for neonates (before and just after eyes open), natural light only
...
3. **Name and file**: upload to the site's shared album, named `date_dogname_site` (e.g. `0717_Mochi_K4`)
4. **Send**: boarding dogs' photos go to owners **the same day** via reception or the site lead; adoption photos are published after manager review
5. **Social**: every Friday each site hands its 2–3 best pieces to marketing
...
Every good photo earns a little more client trust. For equipment questions or to borrow the company camera, contact your site lead; for anything else, contact FluffyWA: 0405 098 765 / admin@fluffywa.com.au.
