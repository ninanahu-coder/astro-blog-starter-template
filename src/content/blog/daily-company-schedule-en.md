...
This is the company-level companion to the *FluffyWA Kennel Work Schedule*: the full day from 07:00 to 18:00, aligned across **all four sites (K1–K4)** so every time block shows what each site is doing and who coordinates at company level. Site leads execute their column; the duty manager follows the "Company coordination" column.

## Company Staffing Overview

| Time window | Staff per site | Company total | Type |
| --- | --- | --- | --- |
| 07:00 – 09:00 | 0.5 | **2 staff** | Morning duty |
| 09:00 – 12:00 | 1.5 | **6 staff** | Morning core block |
| 12:00 – 13:00 | 0.5 | **2 staff** | Midday duty |
| 13:00 – 16:00 | 1.5 | **6 staff** | Afternoon core block |
...
### Morning duty 07:00 – 09:00 (0.5 staff per site)

| Time | K1 (15 dogs) | K2 (35 dogs) | K3 (100 dogs, zoned) | K4 (10 adults + 15 puppies) | Company coordination |
| --- | --- | --- | --- | --- | --- |
| 07:00 – 07:30 | Opening patrol, 15 kennels | Opening patrol, 35 kennels | Patrol zones A, B | Puppy area first, then adults | Duty manager on standby |
| 07:30 – 08:00 | Water, ventilation on | Water, ventilation on | Patrol zones C, D; water A, B | Puppies' first meal (soaked kibble); adult water | Collect anomaly reports from all sites |
| 08:00 – 08:30 | Prep, verify feeding charts | Prep, verify feeding charts | Water C, D; prep | Prep; confirm today's booking list | Arrange today's cross-site support |
| 08:30 – 09:00 | Handover to core shift | Handover to core shift | Handover; assign zones | Disinfect reception area, open desk | Roll call across 4 sites (phone) |

### Morning core block 09:00 – 12:00 (1.5 staff per site)

| Time | K1 | K2 | K3 | K4 | Company coordination |
| --- | --- | --- | --- | --- | --- |
| 09:00 – 09:45 | Breakfast + intake log | Breakfast + intake log | Feed by zone: A, B then C, D | Puppies' second meal; adult breakfast; reception opens | Duty manager handles calls and bookings |
| 09:45 – 11:00 | Clean kennels, wash bowls | Clean kennels, wash bowls | Zone cleaning rolling A→B→C→D | Full shift cleans; half shift on reception (until 11:00) | Assign new arrivals to sites (size/temperament) |
| 11:00 – 12:00 | Exercise round 1: 3 × 5 dogs | Exercise round 1: 6 × 6 dogs | Round 1: zones A, B in 5 batches each | Adults 2 batches; puppies 15 min in own yard | Inter-site transfers (if any) |

### Midday duty 12:00 – 13:00 (0.5 staff per site)

| Time | K1 | K2 | K3 | K4 | Company coordination |
| --- | --- | --- | --- | --- | --- |
| 12:00 – 13:00 | Patrol, water | Patrol, water | Patrol all zones, water | Patrol; check napping puppies | Duty manager phones all four sites |

### Afternoon core block 13:00 – 16:00 (1.5 staff per site)

| Time | K1 | K2 | K3 | K4 | Company coordination |
| --- | --- | --- | --- | --- | --- |
| 13:00 – 14:00 | Disinfection; booked grooming | Disinfection; booked grooming | Zone disinfection: A, B | Disinfection (puppy-safe products) | Grooming bookings, customer notices |
| 14:00 – 15:15 | Exercise round 2 + social | Exercise round 2 + social | Disinfect C, D interleaved with exercise; A, B exercise | Adults round 2; puppies' third meal + socialisation | Weekly tasks (per weekly workflow) |
| 15:15 – 16:00 | Dinner; stocktake | Dinner; stocktake | Feed by zone + stocktake | Adult dinner; puppies' fourth meal; stocktake | Consolidate supply gaps from all sites |

### Evening duty 16:00 – 18:00 (0.5 staff per site)

| Time | K1 | K2 | K3 | K4 | Company coordination |
| --- | --- | --- | --- | --- | --- |
| 16:00 – 17:00 | Evening patrol, water | Evening patrol, water | Zone patrol, water | **Reception peak**: booked pick-ups/drop-offs | Duty manager backs up K4 reception |
| 17:00 – 17:45 | Close yards, check locks | Close yards, check locks | Close zone yards, check fencing and locks | Reception continues; settle puppies | Clear the day's open items |
| 17:45 – 18:00 | Log, lock up | Log, lock up | Log, lock up, lead signs off | Log, close desk, lock up | Compile daily report, post tomorrow's plan |
